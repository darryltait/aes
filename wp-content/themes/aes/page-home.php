...
<div class="row full-page-web">
        <!-- <div class="col-12 col-md-6 side"> -->
        <!-- <div class="col-12 side fade-in"> -->
        <div class="container">
        <div class="fade-in">
         
        <h1 class="heading-title text-center display-4">Now, I'm on the web side of things...</h1>
        </div>

        <!-- <div class="col-12 col-md-6 web-side side "> -->
        <div class="col-12 web-side side heading-title text-center fade-in">
        <h2 class="py-3 text-center heading-title">Assisting clients with their presence on the web.</h2>
        </div>
        <div class="fade-in">
        <p>Specializing in building custom-themed WordPress sites. I enjoy working with businesses to create sites that reflect who they are and what they do. I like the flexibility of WordPress, using custom themes, that allow me to create whatever they want — and not be limited to a standard look.</p>
...
<div class="row">
<div class="fade-in">
        <h2 class="text-center heading-title py-3">Current work in progress...</h2>
        </div>
        ...
        <div class="current-container">
            ...
            <a href="https:///darienbogart.com" target="_blank">
            
            <div class="site">
            
            <p>A custom-themed WP site for an artist. The site will allow him to add new paintings, show where one can see his work and display photos of his art taken from buyers — as well as editing his about info, contact info and blog.</p>
