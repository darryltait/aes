...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20220610_darryltait_bcadc8b9d0a2c54d2036_20220610180212_archive.zip';
	const ARCHIVE_SIZE		 = '47526464';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'bcadc8b-10180212';
    const SECONDARY_PACKAGE_HASH = 'a21637e-10180212';
	const VERSION			 = '1.4.5';
