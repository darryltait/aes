...
<h2 class="name center pg-bottom">Now, I'm on the web side of things...</h2>
       ...
       <div class="fade-in"> 
        <h2 class="name center pg-bottom">Assisting clients with their presence on the web.</h2>
</div>
<div class="fade-in">
        <p>Specializing in building custom-themed WordPress sites. I enjoy working with businesses to create sites that reflect who they are and what they do. I like the flexibility of custom WordPress themes that allow me to create what they want — and then to be able to hand over the reigns for them to add things to the site on their own. I'm also available to assist them with updates if requested.</p>
</div>
<div class="fade-in">
        <h2 class="name center">Current work in progress...</h2>
        </div>
        
        <div class="current-container">
            
            <section class="left from-left slide-in ">
            
            <a href="https:///dbs.aspeneyestudio.com" target="_blank">
            
            <div class="site">
            
            <p>A custom-themed WP site for an artist. The site will allow him to add new paintings, show where one can see his work and display photos of his art taken from buyers — as well as editing his about info, contact info and blog. I'm awaiting final copy and images from the client before going live.</p>
           
            <img src="<?php echo get_template_directory_uri(); ?>/img/dbs-cover.png" alt="" class="">
            </div>
            
            </a>

            </section>
            <section class="right from-right slide-in">
              <!-- <h2>Need an extra set of eyes to look over work you’re doing for clients?</h2>
            <h2>We can help you with that. </h2> -->
            <a href="https:///kmb.aspeneyestudio.com" target="_blank">
              <div class="site">
              <p>A custom-themed WP site for a handy-man business. It will allow him to display the services he provides, galleries of completed jobs and his reviews on Google and Nextdoor. I'm awaiting final copy and images from the client before going live.</p>
            <img src="<?php echo get_template_directory_uri(); ?>/img/kmb-front.png" alt="">
            </div>
          </a>
        ...
        <h2 class="name center fade-in projects">Projects...</h2>
        <div class="current-container">
            
            <section class="left from-left slide-in">
              <!-- <h2>Need a modern, responsive, website to showcase your business or brand?</h2>
            <h2>We can help you with that. </h2> -->
            <a href="http://campsights.herokuapp.com/" target="_blank">
              <div class="site">
              <p>A full-CRUD app using Node.js, Express, Mongoose and MongoDB where you can see campgrounds that others like and add ones you enjoy to the list. To see sites added by others and add ones of your own, you must login and be authenticated using a Gmail account.</p>
            <img src="<?php echo get_template_directory_uri(); ?>/img/campsights.png" alt="">
            </div>
          </a>
            ...
            <section class="right from-right slide-in">
              <!-- <h2>Need an extra set of eyes to look over work you’re doing for clients?</h2>
            <h2>We can help you with that. </h2> -->
            <a href="https://darryltait.github.io/brewery-finder/" target="_blank">
              <div class="site">
              <p>A simple app that allows anyone to easily find breweries located in their city. Enter a city name, and retrieve the local breweries via the openbrewerydb.org API.The app was created using HTML5, CSS3, JavaScript, jQuery and AJAX.</p>
            <img src="<?php echo get_template_directory_uri(); ?>/img/breweryfinder.png" alt="">
            </div>
          </a>
        ...
        <!-- <div class="full-page">
            <h2>Not satisfied with your current website or need one built?</h2>
            <h3>Reach out and let's get that fixed!</h3>
        </div> -->
